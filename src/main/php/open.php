...
<p>Generate a RDF representation which describes your data.<br />
Interact with the RDF4Sensors application either by using our <a
...
<span style="font-weight: bold;">Sensor</span><br />
...
<div style="border-style: solid; border-width: thin;"
	id="platform-info"><span style="font-weight: bold;">Platform / Testbed</span><br />
...
<div style="border-style: solid; border-width: thin;"
	id="measurement-info"><span style="font-weight: bold;">Measurement Capability</span><br />
...
Sensor Capability(<?php echo $count;?>): <input type="text"
	name="myInputs[]" value="<?php echo $capab; ?>" /> Property - min/max -
unitOfMeasurement,symbol
<div id="conditions_set"><?php 
if (isset($conditions[$count])&& $conditions[$count]){?>
<div id="conditions<?php echo $count;?>"><?php 
$condition_count = 1;
foreach($conditions as $cond){	?> InCondition(<?php echo $condition_count;?>):
<input type="text" name="myCondition[<?php echo $count;?>][]"
	value="<?php echo $cond; ?>" /> <?php
...
<div id="conditions1">InCondition(1): <input type="text"
	name="myCondition[1][]" value="Temperature - -40/-35 - Fahrenheit,F" /> <input type="button"
	value="Add more Conditions" onclick="addCondition('conditions1', 1);" />
</div>
</div>
<br />
<input type="button" value="Add more Capabilities"
	onclick="addInput('capabilities');" /> <?php }?></div>
	</div><br />

<div style="border-style: solid; border-width: thin;"
	id="device-info"><span style="font-weight: bold;">Device</span><br />
...
Feature of Interest(FOI): <input type="text" name="sensor_foi_name"
	...
	value="<?php if (isset($foi)) echo $foi; else echo "Room"; ?>" />
	<br />

</div><br />

<div style="border-style: solid; border-width: thin;"
	id="activity-info"><span style="font-weight: bold;">Activity / Stimulus</span><br />
Sensor Owner: <input type="text" name="sensor_owner"
	value="<?php if (isset($sensor_owner)) echo $sensor_owner; else echo ""; ?>" /><br />
Sensor Data Publisher: <input type="text" name="sensor_publisher"
	value="<?php if (isset($sensor_publisher)) echo $sensor_publisher; else echo ""; ?>" /><br />
...
<div style="border-style: solid; border-width: thin;"
	id="sensor-network-info"><span style="font-weight: bold;">Sensor Network</span><br />
Sensor Owner: <input type="text" name="sensor_owner"
	value="<?php if (isset($sensor_owner)) echo $sensor_owner; else echo ""; ?>" /><br />
Sensor Data Publisher: <input type="text" name="sensor_publisher"
	value="<?php if (isset($sensor_publisher)) echo $sensor_publisher; else echo ""; ?>" /><br />
...
<div style="border-style: solid; border-width: thin;"
	id="link-info"><span style="font-weight: bold;">Link</span><br />
Sensor Owner: <input type="text" name="sensor_owner"
	value="<?php if (isset($sensor_owner)) echo $sensor_owner; else echo ""; ?>" /><br />
Sensor Data Publisher: <input type="text" name="sensor_publisher"
	value="<?php if (isset($sensor_publisher)) echo $sensor_publisher; else echo ""; ?>" /><br />
...
<div style="border-style: solid; border-width: thin;"
	id="link-review-info"><span style="font-weight: bold;">Link Feedback</span><br />
Sensor Owner: <input type="text" name="sensor_owner"
	value="<?php if (isset($sensor_owner)) echo $sensor_owner; else echo ""; ?>" /><br />
Sensor Data Publisher: <input type="text" name="sensor_publisher"
	value="<?php if (isset($sensor_publisher)) echo $sensor_publisher; else echo ""; ?>" /><br />
...
<div><span style="font-weight: bold;">Intrinsic node description - to be
stored on the sensor node:</span>
<div id="serialization_intrinsic" style="overflow: auto"><?php echo $ser_intrinsic; ?>
</div>
</div>

<div><span style="font-weight: bold;">Sider information regarding the
...
<div><span style="font-weight: bold;">Additional node-dependent
description - to be stored anywhere:</span>
<div id="serialization_additional_node" style="overflow: auto"><?php echo $ser_additional_node; ?></div>
</div>

<?php } if ($ser_additional_owner){ ?>
<div><span style="font-weight: bold;">Additional owner-dependent
description - to be stored anywhere:</span>
